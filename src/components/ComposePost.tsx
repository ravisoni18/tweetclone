...
const ComposePost: React.FC<ComposePostProps> = ({ onPostCreated, autoFocus = false }) => {
  ...
  return (
    <>
      <div className={`bg-black border-b border-gray-800 ${isMobile ? 'p-3' : 'p-4'}`} style={{ backgroundColor: 'var(--bg)', borderColor: 'var(--border)' }}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className={`flex items-center justify-between ${isMobile ? 'mt-3 pt-3' : 'mt-4 pt-4'} border-t border-gray-800`} style={{ borderColor: 'var(--border)' }}>
                ...
                <button
                  ...
                  className={`${isMobile ? 'px-5 py-2 text-sm' : 'px-6 py-2'} rounded-full font-semibold transition-all touch-manipulation bg-blue-500 hover:bg-blue-600 text-white ${
                    isButtonDisabled
