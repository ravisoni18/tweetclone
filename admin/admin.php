    ...
    if ($action === 'approve') {
        ...
        <div style='font-family:Arial,sans-serif;max-width:600px;margin:0 auto;'>
          ...
          <div style='padding:32px;background:#f8fafc;border-radius:0 0 12px 12px;border:1px solid #e2e8f0;text-align:center;'>
            ...
            <a href='" . rtrim(getenv('APP_BASE_URL'), '/') . "/patr/'
...
case 'flag':
    if ($method === 'POST') {
        ...
        $htmlBody .= "<a href='" . rtrim(getenv('APP_BASE_URL'), '/') . "' style='background:#00d4ff;color:#0d1321;font-size:14px;font-weight:700;text-decoration:none;padding:14px 32px;border-radius:50px;display:inline-block;'>Visit Patr.me</a>";
        $htmlBody .= "</div></td></tr>";
        ...
        case 'invite-approve':
            if ($method === 'POST') {
                ...
                try {
                    ...
                    $htmlBody .= "<a href='" . rtrim(getenv('APP_BASE_URL'), '/') . "/patr/' style='display:inline-block;background:#1d9bf0;color:#fff;padding:14px 36px;border-radius:50px;text-decoration:none;font-weight:bold;font-size:16px;margin-top:24px;'>Join Patr →</a>";
                    $htmlBody .= "</td></tr>";
